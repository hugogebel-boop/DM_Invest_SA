    ...
    <section id="contact" className="bg-tableau-blue text-white">
      ...
      <div className="py-10 sm:py-12 md:py-16 lg:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          <AnimateOnScroll>
            <h2 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl font-serif text-white mb-8 sm:mb-12 md:mb-16 text-left font-normal tracking-tight">
              Contact
            </h2>
          </AnimateOnScroll>
