      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        <AnimateOnScroll>
          <div className="space-y-5 sm:space-y-6 text-base sm:text-lg md:text-lg lg:text-xl text-anthracite leading-relaxed">
            ...
            <p>
              Elle propose, depuis sa création en <span className="font-bold">1999</span>, une stratégie d&apos;investissement pragmatique et basée sur une analyse macroéconomique. La sélection de titres découle de cette analyse et est en phase avec les cycles économiques.
            </p>
          </div>
        </AnimateOnScroll>
      </div>
