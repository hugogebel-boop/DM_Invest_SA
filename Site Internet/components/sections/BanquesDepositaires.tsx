    ...
    <section className="py-16 sm:py-20 md:py-24 lg:py-24 xl:py-28 bg-ivory">
      <div className="max-w-[1000px] mx-auto">
        ...
        <AnimateOnScroll delay={0.1}>
          <div className="pl-4 sm:pl-6 md:pl-8 pr-4 sm:pr-6 md:pr-8 flex flex-wrap justify-center sm:justify-between w-full gap-4 sm:gap-6 md:gap-8">
            <div className="w-[45%] sm:flex-1 flex items-center justify-center">
              <div className="relative w-full h-24 sm:h-28 md:h-32 lg:h-36 bg-ivory flex items-center justify-center overflow-hidden">
                <Image
                  ...
                  sizes="(max-width: 640px) 160px, (max-width: 768px) 160px, 200px"
                />
              </div>
            </div>
            <div className="w-[45%] sm:flex-1 flex items-center justify-center">
